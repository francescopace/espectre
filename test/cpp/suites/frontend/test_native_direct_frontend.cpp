...
void test_native_frontend_direct_exposes_portal_reads_without_secrets(void) {
  frontend_runtime_shim::state.snapshot = make_ready_snapshot();
  frontend_runtime_shim::state.diagnostics.csi.rx_error_total = 1U;
  frontend_runtime_shim::state.diagnostics.csi.rx_end_error_total = 2U;
  frontend_runtime_shim::state.diagnostics.csi.invalid_estimate_total = 3U;
  frontend_runtime_shim::state.diagnostics.csi.invalid_first_word_total = 4U;
  frontend_runtime_shim::state.diagnostics.csi.sanitized_first_word_total = 5U;
  frontend_runtime_shim::state.diagnostics.csi.provenance_rejected_total = 6U;
  ...
  frontend_runtime_shim::state.diagnostics.performance.window_duration_us = 10000000U;
  frontend_runtime_shim::state.diagnostics.performance.runtime_load_percent = 7.5f;
  frontend_runtime_shim::state.diagnostics.performance.loop_samples = 100U;
  frontend_runtime_shim::state.diagnostics.performance.loop_average_us = 75U;
  frontend_runtime_shim::state.diagnostics.performance.loop_maximum_us = 250U;
  frontend_runtime_shim::state.diagnostics.performance.detection_timing_supported = true;
  frontend_runtime_shim::state.diagnostics.performance.detection_samples = 40U;
  frontend_runtime_shim::state.diagnostics.performance.detection_sum_us = 4000U;
  frontend_runtime_shim::state.diagnostics.performance.detection_average_us = 100U;
  frontend_runtime_shim::state.diagnostics.performance.detection_minimum_us = 80U;
  frontend_runtime_shim::state.diagnostics.performance.detection_maximum_us = 140U;
  MockMqttTransport mqtt;
  MockDirectHttpService direct;
