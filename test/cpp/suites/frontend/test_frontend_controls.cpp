...
void test_espectre_component_publishes_cached_csi_diagnostics_on_demand(void) {
  ...
  frontend_runtime_shim::state.diagnostics.link.channel = 8U;
  frontend_runtime_shim::state.diagnostics.link.rssi_dbm = -60;
  ...
  frontend_runtime_shim::state.diagnostics.csi.admitted_total = 80U;
  frontend_runtime_shim::state.diagnostics.csi.filtered_total = 10U;
  frontend_runtime_shim::state.diagnostics.csi.pending_frame_drops_total = 5U;
  frontend_runtime_shim::state.diagnostics.csi.missing_slots_total = 20U;
  frontend_runtime_shim::state.diagnostics.csi.excess_total = 10U;
  frontend_runtime_shim::state.diagnostics.csi.stale_total = 2U;
  frontend_runtime_shim::state.diagnostics.csi.out_of_order_total = 1U;
  frontend_runtime_shim::state.diagnostics.csi.occupancy_slots = 80U;
  frontend_runtime_shim::state.diagnostics.csi.window_slots = 100U;
  component.setup();
  ...
  frontend_runtime_shim::state.diagnostics.csi.admitted_total = 480U;
  frontend_runtime_shim::state.diagnostics.csi.filtered_total = 40U;
  frontend_runtime_shim::state.diagnostics.csi.pending_frame_drops_total = 15U;
  frontend_runtime_shim::state.diagnostics.csi.missing_slots_total = 120U;
  frontend_runtime_shim::state.diagnostics.csi.excess_total = 60U;
  frontend_runtime_shim::state.diagnostics.csi.stale_total = 7U;
  frontend_runtime_shim::state.diagnostics.csi.out_of_order_total = 3U;
  frontend_runtime_shim::state.diagnostics.csi.occupancy_slots = 85U;
