/*
 * ESPectre - Replay Packet Timing
 *
 * Packet-cadence estimation and duration-to-sample-count rules used by the C++
 * replay harness. Counterpart of the same helpers in
 * tools/lib/runtime_policy.py; keep the two aligned, because the performance
 * report compares both replays.
 *
