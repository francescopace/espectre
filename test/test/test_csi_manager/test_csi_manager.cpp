...
void test_csi_manager_init_with_hampel(void) {
    ...
    manager.init(&g_processor, TEST_SUBCARRIERS, 1.0f, 50, 100, true, 11.0f, true, 7, 3.0f, GainLockMode::AUTO, &g_wifi_mock);
...
void test_csi_manager_process_packet_detects_motion(void) {
    ...
    manager.init(&g_processor, TEST_SUBCARRIERS, 0.01f, 5, 100, true, 11.0f, false, 7, 3.0f, GainLockMode::AUTO, &g_wifi_mock);
...
void test_csi_manager_callback_invoked(void) {
    ...
    manager.init(&g_processor, TEST_SUBCARRIERS, 1.0f, 50, 5, true, 11.0f, false, 7, 3.0f, GainLockMode::AUTO, &g_wifi_mock);
...
void test_csi_manager_full_workflow(void) {
    CSIManager manager;
    manager.init(&g_processor, TEST_SUBCARRIERS, 1.0f, 20, 50, true, 11.0f, true, 7, 3.0f, GainLockMode::AUTO, &g_wifi_mock);
...
void test_csi_manager_baseline_then_motion(void) {
    ...
    manager.init(&g_processor, TEST_SUBCARRIERS, 0.5f, 10, 20, false, 11.0f, false, 7, 3.0f, GainLockMode::AUTO, &g_wifi_mock);
    manager.enable(test_callback);
