...
globalThis.__analyticsTest = {
    analyticsAllowedHere, enableAnalytics, getRouteTitle, getSiteSection,
    routePath, sendStaticPageView, trackEvent,
    enabled: () => analyticsEnabled
};`;

function analyticsContext({ hostname = 'espectre.dev', path = '/', hash = '', staticPage = false } = {}) {
    ...
    const context = vm.createContext({
        console, Date, Map, Set, URL, Object, navigator: {}, document, location,
