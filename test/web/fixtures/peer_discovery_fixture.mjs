...
export const DIRECT_PORT = 62587;
...
export const peerDiscoveryScenarios = Object.freeze({
    multiFrontend: result([
        peer(),
        peer({ device_id: '2222222222222222', instance: 'ESPHome sensor', hostname: 'espectre-2222222222222222', name: 'ESPHome sensor', frontend: 'esphome', chip: 'esp32c6', capabilities: ['config', 'monitor'], addresses: ['192.168.1.44'] }),
    ...
    mixedAddresses: result([
        peer(),
        peer({ device_id: 'fedcba9876543210', instance: 'Office sensor', hostname: 'espectre-fedcba9876543210', name: 'Office', frontend: 'esphome', chip: 'esp32s3', capabilities: ['monitor'], addresses: ['fd12:3456:789a::42'] })
    ]),
    ...
    websocket: result([peer({ transport: 'websocket', path: '/espectre/v1/ws', events: '' })]),
