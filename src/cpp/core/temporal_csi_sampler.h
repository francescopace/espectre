...
#ifndef ESPECTRE_TEMPORAL_COVERAGE_NUMERATOR
#define ESPECTRE_TEMPORAL_COVERAGE_NUMERATOR 7
#endif
#ifndef ESPECTRE_TEMPORAL_COVERAGE_DENOMINATOR
#define ESPECTRE_TEMPORAL_COVERAGE_DENOMINATOR 10
#endif
constexpr uint8_t TEMPORAL_CSI_MINIMUM_COVERAGE_NUMERATOR =
    ESPECTRE_TEMPORAL_COVERAGE_NUMERATOR;
constexpr uint8_t TEMPORAL_CSI_MINIMUM_COVERAGE_DENOMINATOR =
    ESPECTRE_TEMPORAL_COVERAGE_DENOMINATOR;
