...
inline NormalizedCSIPayload normalize_ht20_csi_payload(const int8_t *csi_data,
                                                       size_t csi_len,
                                                       int8_t *remap_buffer,
...
inline const char *normalized_csi_payload_tag_to_string(NormalizedCSIPayloadTag tag) {
  switch (tag) {
