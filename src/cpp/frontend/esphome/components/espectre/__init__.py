...
SEGMENTATION_WINDOW_SIZE_MS_DEFAULT = _RUNTIME_SCHEMA["RUNTIME_WINDOW_SIZE_MS_DEFAULT"]
SEGMENTATION_WINDOW_SIZE_MS_MIN = _RUNTIME_SCHEMA["RUNTIME_WINDOW_SIZE_MS_MIN"]
SEGMENTATION_WINDOW_SIZE_MS_MAX = _RUNTIME_SCHEMA["RUNTIME_WINDOW_SIZE_MS_MAX"]
