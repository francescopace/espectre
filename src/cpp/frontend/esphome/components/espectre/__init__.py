...
PUBLISH_INTERVAL_MS_MAX = _RUNTIME_SCHEMA["RUNTIME_PUBLISH_INTERVAL_MS_MAX"]
...
CONFIG_SCHEMA = cv.Schema({
    ...
    cv.Optional(CONF_PUBLISH_INTERVAL_MS, default=PUBLISH_INTERVAL_MS_DEFAULT): cv.int_range(
        min=PUBLISH_INTERVAL_MS_MIN, max=PUBLISH_INTERVAL_MS_MAX
    ),
