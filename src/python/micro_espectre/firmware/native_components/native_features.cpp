...
extern "C" uint32_t espectre_native_sampler_get_u32(void *handle, uint8_t field) {
    ...
    switch (field) {
        case 0: return sampler->target_pps();
        case 1: return sampler->window_size_ms();
        case 2: return sampler->window_slots();
        case 3: return sampler->minimum_valid_slots();
        case 4: return sampler->minimum_sample_spacing_us();
        case 5: return sampler->occupancy_slots();
        default: return 0U;
    }
}
...
extern "C" uint64_t espectre_native_sampler_get_u64(void *handle, uint8_t field) {
    ...
    switch (field) {
        case 0: return sampler->current_slot();
        case 1: return sampler->slots_advanced();
        case 2: return sampler->missing_slots_before();
        case 3: return sampler->accepted_packets();
        case 4: return sampler->excess_packets();
        case 5: return sampler->duplicate_packets();
        case 6: return sampler->out_of_order_packets();
        case 7: return sampler->stale_packets();
        case 8: return sampler->missing_timestamp_packets();
        case 9: return sampler->missing_slots();
        case 10: return sampler->gap_resets();
        default: return 0U;
    }
}
...
extern "C" bool espectre_native_sampler_get_flag(void *handle, uint8_t field) {
    ...
    switch (field) {
        case 0: return sampler->is_ready();
        case 1: return sampler->accepted();
        case 2: return sampler->selected_current();
        case 3: return sampler->has_pending_candidate();
        case 4: return sampler->reset_required();
        case 5: return sampler->gap_reset_required();
