...
Dataset revision: `sha256:7201884c96b8c87176e388178b1e00fdc448f98e0d04f027c55fefeaae17d711`
Input revision: `sha256:22504866a77494b5626b8b7aef0d1821a2213b3abc885e7d49a3e1ea99d1eb65`
Generated by: `tools/generate_performance_report.py`
Run started: `2026-09-24T17:19:42+02:00`
Run duration: `3m 14.88s`
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Lightweight | 2,016 B | 0.13 / 0.16 us | 0.94 / 0.94 us | 16.38 us/s | 0 B |
| High Accuracy | 5,068 B | 0.41 / 0.42 us | 2.27 / 2.27 us | 50.42 us/s | 0 B |
...
|--------|----------|----------|----------|----------|----------|
| Recall | 99.4% | 100.0% | 100.0% | N/A | 100.0% |
| Min Recall | 98.9% | 100.0% | 100.0% | N/A | 100.0% |
| Precision | 99.9% | 94.6% | 98.9% | N/A | 98.1% |
| FP Rate | 0.1% | 2.9% | 0.6% | N/A | 1.0% |
| Max FP Rate | 0.1% | 2.9% | 0.6% | N/A | 1.0% |
...
| --- | --- | ---: | ---: | ---: |
| Lightweight | Reserved, mixed two-seed augmentation (13 pairs) | 98.7% | 0.8% | 98.6% |
...
| Metric | ESP32-C3 | ESP32-C5 | ESP32-C6 | ESP32 | ESP32-S3 |
|--------|----------|----------|----------|----------|----------|
| Recall | 99.3% | 97.2% | 99.7% | N/A | 99.1% |
| Min Recall | 98.5% | 94.4% | 99.7% | N/A | 98.6% |
| Precision | 99.7% | 95.3% | 98.9% | N/A | 97.9% |
| FP Rate | 0.1% | 2.4% | 0.6% | N/A | 1.1% |
| Max FP Rate | 0.3% | 4.9% | 0.6% | N/A | 2.1% |
| F1-Score | 99.5% | 96.2% | 99.3% | N/A | 98.5% |
...
|--------|----|----|----|----|----|
| Avg FP Rate | 0.00% | N/A | 1.70% | N/A | 0.61% |
| Max FP Rate | 0.00% | N/A | 2.38% | N/A | 1.22% |
| Effective Alarms | 0 | N/A | 6 | N/A | 3 |
