...
- **One versioned protocol covers setup over BLE and operation over MQTT**. BLE provisions Wi-Fi, MQTT, and identity settings. MQTT handles discovery, telemetry, diagnostics, OTA, and live sensing commands.
