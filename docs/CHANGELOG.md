...
- **Native Wi-Fi changes are verified before they become durable and finish with one automatic reboot**. The runtime disarms CSI before station reconfiguration, commits a candidate only after association and address acquisition, rolls back to the last-known-good network on failure, and restarts after a successful commit or rollback so ESP32-C3 CSI capture returns cleanly.
