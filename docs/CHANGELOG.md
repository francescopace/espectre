...
- **Host-side ML candidate framework and a `--features` trainer flag**: production and host-only feature combinations can be evaluated without changing runtime extractors. Candidate-only runs require `--no-export`; export remains restricted to the five-feature production set. The feature inventory and accumulated evidence live in [FEATURES.md](FEATURES.md).
...
- [`docs/adr/2026-07-28-drop-the-absolute-l1-features.md`](adr/2026-07-28-drop-the-absolute-l1-features.md) (active five-feature ML decision and supersession chain)
