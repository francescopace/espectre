...
- **ESPHome intensity and on-demand CSI diagnostics**. The new intensity sensor stays meaningful across automatic Lightweight calibration, while the diagnostics surface reports traffic, CSI callback, accepted and filtered packet rates, Wi-Fi channel, and RSSI only when requested.
