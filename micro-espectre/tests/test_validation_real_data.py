...
ML motion model is binary (IDLE/MOTION). Gesture-specific recordings
(wave, etc.) are excluded from motion-model validation datasets.
...
from features import (
    calc_skewness, calc_entropy_turb,
