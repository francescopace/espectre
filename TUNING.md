...
**Fallback behavior:** If band selection fails (e.g., due to poor signal quality), normalization is still calculated using the default subcarriers. This ensures motion detection remains usable even when P95 calibration cannot find optimal subcarriers.
