...
TEST_CASE_ESP("Calibration with real CSI data", "[calibration][real]")
{
    ...
    calibration_start(100, &config, &normalizer);
    ...
    // Process all 10 baseline packets
    for (int p = 0; p < 10; p++) {
        const int8_t *csi_data;
        switch(p) {
            case 0: csi_data = real_baseline_0; break;
            case 1: csi_data = real_baseline_1; break;
            case 2: csi_data = real_baseline_2; break;
            case 3: csi_data = real_baseline_3; break;
            case 4: csi_data = real_baseline_4; break;
            case 5: csi_data = real_baseline_5; break;
            case 6: csi_data = real_baseline_6; break;
            case 7: csi_data = real_baseline_7; break;
            case 8: csi_data = real_baseline_8; break;
            case 9: csi_data = real_baseline_9; break;
            default: csi_data = real_baseline_0;
        }
        
        // Process each packet multiple times to simulate continuous traffic
        for (int rep = 0; rep < 10; rep++) {
            csi_features_t features;
            csi_extract_features(csi_data, 128, &features);
    ...
    // Force to MOVEMENT phase
    calibration_force_phase(CALIB_MOVEMENT);
    printf("Processing MOVEMENT phase with real CSI data...\n");
    
    // Process all 10 movement packets
    for (int p = 0; p < 10; p++) {
        const int8_t *csi_data;
        switch(p) {
            case 0: csi_data = real_movement_0; break;
            case 1: csi_data = real_movement_1; break;
            case 2: csi_data = real_movement_2; break;
            case 3: csi_data = real_movement_3; break;
            case 4: csi_data = real_movement_4; break;
            case 5: csi_data = real_movement_5; break;
            case 6: csi_data = real_movement_6; break;
            case 7: csi_data = real_movement_7; break;
            case 8: csi_data = real_movement_8; break;
            case 9: csi_data = real_movement_9; break;
            default: csi_data = real_movement_0;
        }
        
        // Process each packet multiple times
        for (int rep = 0; rep < 10; rep++) {
            csi_features_t features;
            csi_extract_features(csi_data, 128, &features);
