...
ROUTE_SOURCES = {
    ...
    "/sdk/": (Path("docs/web/content/docs.html"), STATIC_PAGE_BUILDER),
    "/sdk/api/": (Path("docs/web/content/docs/api.html"), STATIC_PAGE_BUILDER),
    "/sdk/examples/": (Path("docs/web/content/docs/examples.html"), STATIC_PAGE_BUILDER),
    "/sdk/architecture/": (Path("docs/web/content/docs/architecture.html"), STATIC_PAGE_BUILDER),
